...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'/root/ultralytics6.1/ultralytics/cfg/models/v8/yolov8-Gold-context-EMA.yaml')  # 不使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        # data=r'/root/ultralytics6.1/ultralytics/cfg/datasets/fireData.yaml',
        data=r'/root/ultralytics6.1/ultralytics/cfg/datasets/pv31.yaml',
