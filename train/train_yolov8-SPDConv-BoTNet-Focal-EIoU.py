...
if __name__ == '__main__':
    ...
    model = YOLO(r'ultralytics/cfg/models/v8/yolov8-SPDConv-BoTNet.yaml')  # 使用预训练权重训练
    # model = YOLO(r'ultralytics6.1/exp/weights/last.pt')  # 使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        data=r'ultralytics/cfg/datasets/pv65.yaml',
