...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'/root/ultralytics6.1/ultralytics/cfg/models/v8/yolov8-CrissCrossAttention.yaml')  # 不使用预训练权重训练
    # model = YOLO(r'/root/ultralytics6.1/ultralytics/cfg/models/v8/yolov8-CrissCrossAttention.yaml').load("yolov8n.pt")  # 使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        data=r'/root/ultralytics6.1/ultralytics/cfg/datasets/pv01.yaml',
