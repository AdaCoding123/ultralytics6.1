import sys
sys.path.append("/root/ultralytics6.1")
from ultralytics import YOLO

if __name__ == '__main__':
    # 加载模型
    # model = YOLO(r'/root/ultralytics6.1/ultralytics/cfg/models/v8/yolov8-Glod.yaml')  # 不使用预训练权重训练
    model = YOLO(r'/root/ultralytics6.1/ultralytics/cfg/models/v8/yolov8-Glod.yaml').load("yolov8n.pt")  # 使用预训练权重训练
    # 训练参数 ----------------------------------------------------------------------------------------------
    model.train(
        # data=r'/root/ultralytics6.1/ultralytics/cfg/datasets/fireData.yaml',
        data=r'/root/ultralytics6.1/ultralytics/cfg/datasets/fireEyeData.yaml',
        epochs=300,  # (int) 训练的周期数
        patience=5000,  # (int) 等待无明显改善以进行早期停止的周期数
        ...
        project='/root/ultralytics6.1/ultralytics6.1',  # (str, optional) 项目名称
